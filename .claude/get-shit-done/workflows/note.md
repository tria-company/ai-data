...
- **Global scope**: `/Users/igorvboas/Documents/TRIA/social-media-scrapper/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/igorvboas/Documents/TRIA/social-media-scrapper/.claude/notes/`)
...
2. Glob `/Users/igorvboas/Documents/TRIA/social-media-scrapper/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/igorvboas/Documents/TRIA/social-media-scrapper/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/igorvboas/Documents/TRIA/social-media-scrapper/.claude/notes/` — works in any directory
